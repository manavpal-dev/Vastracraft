...
const CollectionPage = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row">
      ...
      >
        <FaFilter className="mr-2 cursor-pointer" />
        Filters
      </button>
      ...
      <div
        ref={sidebarRef}
        className={`${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} fixed inset-y-0 x-50 left-0 w-64 bg-white overflow-y-auto transition-transform duration-300 lg:static lg:translate-x-0 `}
      >
        <div className="flex">
