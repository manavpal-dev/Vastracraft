        ...
        <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg">
          <div className="flex flex-col md:flex-row">
            ...
            mb-2"
                  ...
                  {selectedProduct.sizes.map((size) => (
                    <button
                      ...
                      className={`px-4 py-2 rounded border  transition-all
                               duration-300 ${selectedSize === size ? "bg-black text-white " : "hover:font-semibold"}`}
                    >
                      {size}
                    </button>
                  ))}
              ...
              <button
                className={`bg-black text-white py-2 px-6 rounded w-full mb-4 uppercase font-semibold hover:bg-red-950 transition-all duration-300 ${isButton ? "cursor-not-allowed opacity-50" : "hover:bg-gray-900"}`}
                onClick={handleAddToCart}
                disabled={isButton}
              >
                {isButton ? "Adding.." : "Add to cart"}
              </button>
