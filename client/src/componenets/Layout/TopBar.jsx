...
const TopBar = () => {
  return (
    ...
    // This one is top bar which is in red color
    <div className='bg-[#ea2e0e] text-white'>
        <div className='cointainer mx-auto flex justify-between items-center py-3 px-4'>
            ...
            <div className='text-sm hidden md:block'>
                <a href="tel:9899698835" 
                rel='noopener noreferrer'
                className='hover:text-gray-300'>+91 9899698835</a>
            </div>
